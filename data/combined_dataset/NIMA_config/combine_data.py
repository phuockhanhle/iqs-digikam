...
def add_eva_dataset(sample_file: str, image_dir: str) -> List[Dict[str, Any]]:
    ...
    for idx, sample in enumerate(samples):
        ...
        res.append({"image_path": image_path, "digikam_label": digikam_label})
    print(
        f"data EVA contains {nb_class0} samples of class 0,{nb_class1} samples of class 1, {nb_class2} samples of class 2")
    return res
...
if __name__ == '__main__':
    ...
    data_train = ava_train + eva_train + koniq_train
    data_test = ava_test + eva_test + koniq_test
